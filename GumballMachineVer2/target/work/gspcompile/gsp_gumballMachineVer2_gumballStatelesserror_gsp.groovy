...
class gsp_gumballMachineVer2_gumballStatelesserror_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/gumballStateless/error.gsp" }
public Object run() {
Writer out = getOut()
